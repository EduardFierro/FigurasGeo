...
public class Principal {
    ...
    public void datosCuadrado() {
        ...
        FigurasGeometricas cuadrado = new Cuadrado(coordenadaXC, coordenadaYC, coordenadaXA, coordenadaYA, coordenadaXB, coordenadaYB);
    ...
    public void datosRectangulo() {
        ...
        System.out.print("Ingrese coordenada Y del tercer punto: ");
        coordenadaYC = scannerNumeros.nextDouble();
        FigurasGeometricas rectangulo = new Rectangulo(coordenadaXC, coordenadaYC, coordenadaXA, coordenadaYA, coordenadaXB, coordenadaYB);
    ...
    public void datosTriangulo() {
        ...
        System.out.print("Ingrese coordenada Y del tercer punto: ");
        coordenadaYC = scannerNumeros.nextDouble();
        FigurasGeometricas triangulo = new Triangulo(coordenadaXC, coordenadaYC, coordenadaXA, coordenadaYA, coordenadaXB, coordenadaYB);
